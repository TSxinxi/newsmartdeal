...
export default function App() {
  Sentry.init({
    dsn: "https://9a30969e59209d4eafb20dea41c8edc3@o4506097284677632.ingest.sentry.io/4506097501339648",
    integrations: [
      new Sentry.BrowserTracing({
        // Set 'tracePropagationTargets' to control for which URLs distributed tracing should be enabled
        tracePropagationTargets: ["localhost", /^https:\/\/page.hultoo.com\.io\/api/],
      }),
      new Sentry.Replay(),
    ],
