...
export function getLanguage() {
  ...
  let language = {
    EN: {
      ...
      fullName: 'Full name',
      semail: 'E-mail',
      semailPle: 'Leave your email to get notifications',
      ...
      comments: 'Message',
      commentsPle: 'Write a note if you have',
    ...
    RO: {
      ...
      semail: 'E-mail',
      semailPle: 'Lăsați-vă e-mailul pentru a primi notificări',
      governor: 'Province',
      telephone: 'Telefon',
      ...
      comments: 'Mesaj',
      commentsPle: 'Scrieți o notă dacă aveți',
